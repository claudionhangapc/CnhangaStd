    ...
    <div class="page-orcamento-conteudo-item">
      <div class="page-orcamento-conteudo-item-esquerdo">
        ...
        <div>
          ...
          <input type="text" placeholder="Digite o numero do teu telefone">
        </div>
        <div>
          <label for="">E-mail</label>
          <input type="text" placeholder="Digite o numero do teu email">
        </div>
        <div>
          <label for="">Tipo de evento</label>
          <input type="text" placeholder="Seleciona o tipo de evento">
        </div>
        <div>
          <label for="">Data</label>
          <input type="text" placeholder="Seleciona a data do evento">
        </div>
        <div>
          <label for="">Observações</label>
          <textarea name="" placeholder="Digite aqui a sua observação"></textarea>
        </div>
      </div>
